...
<template>
  <nav
    v-if="!isHidden"
    class="flex rounded-t-[16px] border-gray-200 bg-white shadow-bottom-navbar-shadow justify-around items-center fixed bottom-0 left-0 right-0 max-w-[375px] mx-auto"
  >
